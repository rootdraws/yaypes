    ...
    GovernorPreventLateQuorum
{
     ...
     * @param _initialVotingDelay Initial voting delay in blocks (7200 = ~1 day)
     * @param _initialVotingPeriod Initial voting period in blocks (50400 = ~1 week)
     * @param _initialProposalThreshold Initial proposal threshold
     * @param _quorumNumeratorValue Initial quorum numerator value (4 = 4%)
     * @param _initialVoteExtension Initial vote extension period in blocks
     */
    constructor(
